...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.MyViewHolder> {
    ...
    public MyAdapter2 (Context context, ArrayList<Data> list) {
    ...
    private void updateData() {
        ...
        View myView = inflater.inflate(R.layout.activity_update_expense,null);

        myDialog.setView(myView);

        final AlertDialog dialog = myDialog.create();

        final TextView mType = myView.findViewById(R.id.type_update_expense);
        final EditText mAmount = myView.findViewById(R.id.income_update_expense);
        final EditText mNote = myView.findViewById(R.id.note_update_expense);
        ...
        Button updateBtn  = myView.findViewById(R.id.btn_update_expense);
        Button deleteBtn = myView.findViewById(R.id. btn_cancel_update_expense);
        ...
        updateBtn.setOnClickListener(view -> {
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("ExpenseData").child(FirebaseAuth.getInstance().getCurrentUser().getUid()
            );
